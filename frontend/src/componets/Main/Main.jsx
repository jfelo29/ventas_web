...
export default function Main() {
    ...
    const [cards,] = useState([{ image: "/images/minoxidil_unidad.png", name: "unidad", price: "24.000", target: "_blank", href: "https://vife6306800.mercadoshops.com.ar/locion-barba-aceite-estimulante/up/MLAU303285170?pdp_filters=category%3AMLA417772%7Cseller_id%3A152685387%7Citem_id%3AMLA903193820#position=1&search_layout=stack&type=item&tracking_id=333e0122-9c8b-4e2a-8634-34b90e2db8ee" }, { image: "/images/minoxidil_x3.png", name: "3 minoxidil", price: "79.000", target: "_blank", href: "https://vife6306800.mercadoshops.com.ar/locion-barba-estimulante-x3/up/MLAU215496509?pdp_filters=category%3AMLA417772%7Cseller_id%3A152685387%7Citem_id%3AMLA1124142429 " }, { image: "/images/minoxidil_caja.png", name: "caja minoxidil", price: "145.000", target: "_blank", href: "https://vife6306800.mercadoshops.com.ar/locion-para-barba-x-6-caja/up/MLAU328981831?utm_source=mercadoshops&utm_medium=referral&utm_campaign=whatsapp_share" }]);
